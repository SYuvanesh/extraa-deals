    ...
    children: [
      {
        ...
        children: [
          {
            key: 'alldeals',
            value: { label: "All Deals", counter: 515, link: '#' },
            isLeaf: true,
          },
          {
            key: 'CATEGORIES',
      ...
      },
      {
        ...
        children: [
          {
            key: 'allevents',
            value: { label: "All Events", counter: 364, link: '#' },
            isLeaf: true,
          },
          {
            key: 'CATEGORIES',
      ...
      },
      {
        ...
        children: [
          {
            key: 'allcoupons',
            value: { label: 'All Coupons', counter: 263, link: '#' },
            isLeaf: true,
          },
          {
            key: 'CATEGORIES',
    ...
    return (
      <div className="w-full h-full">
        <header className="relative" ref={refs.setReference}>
          <div className="flex flex-wrap md:flex-nowrap justify-between items-center px-4 md:px-10 py-2 md:py-5 w-full border-0 bg-primary-700 border-neutral-200 h-full md:z-10 bg-purple-800">
            <div className="flex items-center">
              <SfButton
                ...
                className="block md:hidden mr-5 bg-transparent hover:text-white active:bg-primary-900 active:text-white"
              >
              ...
              >
                <picture>
                  ...
                  <img src="https://merchants.extraa.in/assets/logos/extraa-logo.png" alt="Sf Logo" style={{maxHeight:50}}/>
                </picture>
              </a>
            </div>
